#!/usr/bin/env python3
"""
Windows x64 notepad.exe shellcode generator.
Technique: LDR name-hash kernel32 detection -> WinExec("notepad", 1) -> ret
...
# "notepad\0" = 65 74 6F 6E  64 61 70 00  (little-endian dwords)
# dword1: note = 0x65746F6E
# dword2: pad\0 = 0x00646170

ASM = f"""\
BITS 64

; Windows x64 Notepad.exe Shellcode
...
_start:
    ...
    ; rsp+0x20..0x27 : notepad slot 8 bytes
    ...
    ; notepad at rsp+0x20, shadow at new_rsp+0x08..0x27 after call
    mov  dword [rsp+0x20], 0x65746F6E  ; note little-endian
    mov  dword [rsp+0x24], 0x00646170  ; pad + null
